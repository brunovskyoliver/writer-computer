...
- [ ] T033 [US5] **Handed to the user 2026-09-13** (code complete). Manual validation per quickstart.md "Story 5" and the coexistence cases: two panes of one note keep independent modes but share registers (FR-008, FR-027); yank → Cmd+V in another app; copy elsewhere → `p`; "toggle Vim off while recording" leaves no stale indicator
